...
class UserTransaksiController extends Controller
{
    ...
    {	
        ...
        return view('user_transaksi.index' , compact('produk_transaksi'))
    ...
    public function create()
    {
        ...
        return view('user_transaksi.create', ['products' => $products], ['pelanggan' => $pelanggan]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('user_transaksi.index')
    ...
    public function show($id)
    {
        ...
        $products = Product::all();
        $pelanggan = Pelanggan::all();
        return view('user_transaksi.detail', ['Produk_Transaksi' => $Produk_Transaksi,'Product' => $products, 'Pelanggan' => $pelanggan]);
    }
    ...
    public function cetak_pdf($id){
        ...
        $produk_transaksi = Produk_Transaksi::with('pelanggan')
            ->where('id', $id)
            ->get();
        $pdf = PDF::loadview('user_transaksi.transaksi_pdf', compact('produk_transaksi', 'products'));
        return $pdf->stream();
    }
}
